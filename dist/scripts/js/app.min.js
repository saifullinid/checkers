...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"startGameLoop\": () => (/* binding */ startGameLoop)\n/* harmony export */ });\n/* harmony import */ var _request_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./request.js */ \"./src/scripts/js/request.js\");\n/* harmony import */ var _gameData_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gameData.js */ \"./src/scripts/js/gameData.js\");\n/* harmony import */ var _service_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./service.js */ \"./src/scripts/js/service.js\");\n/* harmony import */ var _enemyMoveHandling_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./enemyMoveHandling.js */ \"./src/scripts/js/enemyMoveHandling.js\");\n/* harmony import */ var _ownMoveHandling_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ownMoveHandling.js */ \"./src/scripts/js/ownMoveHandling.js\");\n\r\n\r\n\r\n\r\n\r\n\r\nfunction startGameLoop(url) {\r\n    let currentUrl = url.replace('game', 'start')\r\n    localStorage.setItem('move', '');\r\n    (async function loop() {\r\n        let move = ''\r\n        let method = 'GET';\r\n        let winner = ''\r\n\r\n        while (!winner) {\r\n            let options = {\r\n                method: method,\r\n                url: currentUrl,\r\n                headers: '',\r\n                responseType: 'json',\r\n                params: move,\r\n            }\r\n            let inputGameData = await (0,_request_js__WEBPACK_IMPORTED_MODULE_0__.delay)(options)\r\n            console.log(inputGameData)\r\n            winner = inputGameData['winner']\r\n            if (winner) {\r\n                break\r\n            }\r\n\r\n            (0,_enemyMoveHandling_js__WEBPACK_IMPORTED_MODULE_3__.enemyMoveHandling)(inputGameData)\r\n            move = await (0,_ownMoveHandling_js__WEBPACK_IMPORTED_MODULE_4__.ownMoveHandling)(inputGameData)\r\n        }\r\n        console.log(winner);\r\n    })()\r\n}\n\n//# sourceURL=webpack://checkers/./src/scripts/js/gameLoop.js?");
